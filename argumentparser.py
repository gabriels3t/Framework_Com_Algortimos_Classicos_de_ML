...
class ArgumentParser:
    ...
    def setRandomForestArguments(self):
        self.parser.add_argument('-ne', dest='n_estimators', default=200, type=int, help="number of trees in the forest.")
    ...
    def setSVMArguments(self):
        self.parser.add_argument('-k', dest='kernel', default = 'rbf', help="Specifies the kernel type to be used in the algorithm. It must be one of ‘linear’, ‘poly’, ‘rbf’, ‘sigmoid’, ‘precomputed’ or a callable. If none is given, ‘rbf’ will be used.")
   
    def setXGBoostArguments(self):
        self.parser.add_argument('--n_estimators', type=int, default=300, help='Número de árvores (estimadores)')
        self.parser.add_argument('--max_depth', type=int, default=6, help='Profundidade máxima de cada árvore')
    ...
    def setAllAlgorithmsArguments(self):
        ...
        self.parser.add_argument('-XGB', dest='modelXgboost', action="store_true", required=False, help="use xgboost?")
        self.parser.add_argument('-LGBM', dest='lightgbm', action="store_true", help="use LightGBM?")
        self.parser.add_argument('-CAT', dest='catboost', action="store_true", help="use CatBoost?")
